    ...
    useEffect(() => {
        const fetchAppointmentData = async () => {
            try {
                ...
                const approvedAppointments = appointmentsResponse.data.body.filter(appointment => appointment.Estatus_Compra === 'Aprobada');
    ...
    return (
        <div className="featureddon">
            <div className="topdon">
                <h1 className="titledon">Solicitudes Aprobadas</h1>
...
export default FeaturedAprobadaCompra
