...
const FeaturedABPEntregada = () => {
    ...
    useEffect(() => {
        const fetchBloodTypeData = async () => {
            ...
            const typeResponse = await fetch('https://nodejs-sequelize-restapi-mssql-production.up.railway.app/api/v1/Pinta/Tipo/AB+');
...
export default FeaturedABPEntregada