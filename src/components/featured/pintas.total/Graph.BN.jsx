...
const FeaturedBNTotal = () => {
    ...
    useEffect(() => {
        ...
        const fetchBloodTypeData = async () => {
            const response = await fetch('https://nodejs-sequelize-restapi-mssql-production.up.railway.app/api/v1/Pinta/Tipo/B-');
...
export default FeaturedBNTotal;
