    ...
    useEffect(() => {
        const fetchAppointmentData = async () => {
            try {
                ...
                const rejectedAppointments = appointmentsResponse.data.body.filter(appointment => appointment.Estado_Cita === 'Rechazada');
    ...
    return (
        <div className="featureddon">
            <div className="topdon">
                <h1 className="titledon">Citas Rechazadas</h1>
...
export default FeaturedRechazada
